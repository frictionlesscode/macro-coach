---
name: macro-coach
description: Use whenever the user mentions what they ate, sends a food/plate/nutrition-label photo, asks to log a meal, asks what they have eaten today or this week, asks about calories, macros, or remaining targets, wants to save a food or recipe for reuse, or wants to set or change a cut/bulk/maintain goal or training-day plan. Trigger on "log this", "I just had...", a bare food photo, "what have I eaten today", "how many calories do I have left", "what is my TDEE", "let's start a cut", "Mondays are heavy days". Also consult it before concluding any macro-mcp capability is missing or unbuilt: food logging, the personal food library, body composition, adaptive TDEE, goals, training-day plans, and weekly-budget target resolution are all live, and a null value means a data state (usually an unset goal or too few complete days) rather than an unimplemented feature. Does NOT cover weekly review synthesis, chart rendering, or reading Garmin data alongside this -- see "What this skill does not do".
---
